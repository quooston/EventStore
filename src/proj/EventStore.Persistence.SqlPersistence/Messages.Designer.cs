...
namespace EventStore.Persistence.SqlPersistence {
    ...
    internal class Messages {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Cound not create database command..
        /// </summary>
        internal static string CommandCreation {
            get {
                return ResourceManager.GetString("CommandCreation", resourceCulture);
            }
        }
